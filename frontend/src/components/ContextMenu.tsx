          ...
          {options.map((option, index) => (
            <button
              ...
              className={`
                ...
                ${option.danger ? 'text-red-500 focus:text-red-500' : 'text-popover-foreground'}
              `}
            >
              {option.label}
            </button>
